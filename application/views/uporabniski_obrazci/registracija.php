...
<br><br><label><span>Domislite se še gesla: </span></label><br><input type="password" name="geslo" value=""  />
<br><br><label><span>Pa nam zaupajte še svoj e-naslov: </span></label><br><input type="text" name="enaslov" value=""  />
